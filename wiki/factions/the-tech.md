...
The [AI Node](ai-node) controlling the Tech forces presented themselves as [Calliphon](calliphon) and appear to be directing the invasion at a slower, more calculated pace than the armies that wreaked havoc during the Schism. 
...
Nearly a year later, on Archon, another wave of Tech robots emerged. Controlled by [Menedemos](menedemos), another AI Node, the Tech forces were twice as abundant, but due to the much vaster surface of Archon, they didn’t make much progress in their first attacks, and are now scattered in smaller contingents across the planet’s canyons and caves. 
...
Scattered across various battlefields and hidden facilities lie sealed containers stuffed with dormant droids, quietly awaiting some unknown trigger. 

Occasionally, unsuspecting workers stumble upon these Tech caches, finding them completely inert, and promptly destroy them. 

## Other Schools

[Hermarchus](other-ai-nodes) has been mobilizing small patrols under the methane seas of [Maat](maat), and so far they’ve caused the loss of one of the few functioning deuterium harvester.  
[Bion](other-ai-nodes) has been spotted in orbit around Norn, but they are thought to have advanced cloaking devices that shield their orbital base.  
Lastly, [Cleitomachus](other-ai-nodes) is considered responsible for the fall of two factory-cities on Ruun, but the official reports from the Horstfruden Corporation have been vague and heavily redacted.
