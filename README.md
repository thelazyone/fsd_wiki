...
## Contribute
If you want to add content to the wiki you can submit a pull request, or you can contact me on the #lore channel [in the discord](https://discord.gg/39exwYM9gn) and I'll try to fill all the content with what's canon already.

### Real-Time Update
It's possible to use `docker-composes up` to run a local jeckyll instance and have the wiki updated in realtime and served on localhost:8080 - but I wouldn't recommend it to someone who is not well versed in containers and such. I needed quite a bit of help myself!
